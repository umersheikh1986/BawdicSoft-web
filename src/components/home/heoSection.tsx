...
const HeroSection: FC<HeroSectionProps> = () => {
  return (
    <section className="h-[600px] md:h-[800px] bg-center bg-cover bg-no-repeat bg-[url('https://bawdicsoft.com/wp-content/uploads/2022/08/final-head.webp')] bg-gray-400 bg-blend-multiply">
