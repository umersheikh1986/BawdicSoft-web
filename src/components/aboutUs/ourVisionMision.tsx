...
<div>
    <Image src="https://bawdicsoft.com/wp-content/uploads/2022/08/fg54645.webp" alt=""   className="w-80 h-80 md:w-full md:h-80 " width={600} height={600}/>
</div>
  </div>
  {/*  */}
  <div className="flex justify-evenly items-center flex-wrap pt-10 ">
<div>
    <Image src="https://bawdicsoft.com/wp-content/uploads/2022/08/456564.webp" alt=""   className="w-80 h-60 md:w-full md:h-80 order-1" width={600} height={600}/>
</div>
