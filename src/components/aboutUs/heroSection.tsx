  ...
  return (
    ...
    >
      ...
      <p className="mb-8 text-lg md:text-xl font-normal text-gray-200 pt-5 max-w-5xl text-center">
        ...
        in human potential Lorem ipsum dolor sit amet consectetur adipisicing
        elit. Assumenda, dicta consequatur. Itaque, veniam optio id saepe
        molestias possimus a eligendi!
      </p>
    </section>
  );
};
