...
return (<div>
<section className=" bg-center bg-cover bg-no-repeat bg-[url('https://bawdicsoft.com/wp-content/uploads/2022/08/businessman-touching-virtual-screen.webp')] bg-gray-400 bg-blend-multiply" style={{
