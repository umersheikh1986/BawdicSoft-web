...
<form className="max-w-xl mx-auto">
  ...
  <button type="submit" className="block py-2.5 px-0 w-full text-sm bg-sky-900  text-white   font-semibold rounded-[12px] mt-8 ">Send Message</button>
</form>
    </div>
    

    <div className="flex -ml-32 sm:ml-0 pt-16 md:pt-0 flex-col gap-10">
