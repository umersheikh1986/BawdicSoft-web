...
const FormSection: FC<formSectionProps> = () => {
  ...
  return (<div>
    ...
    {responseData && <Modal result1={responseData} result2={badResponse} />}
      ...
      <div className="bg-gray-200 flex  flex-col items-center px-8">
     ...
     <div className="bg-white flex flex-col items-center  pt-10 pb-16 my-20 rounded-3xl">
      <h3 className="font-bold text-xl md:text-3xl text-gray-600 px-8 text-center">We are Here Whenever Your Need Us</h3>
...
<p className="text-[16px] text-gray-600 font-normal">Mon-Sat: 8 AM-18 PM</p></div>
     ...
     <div className="flex gap-2 pt-5 "><svg className="w-6 h-6 text-gray-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 21">
