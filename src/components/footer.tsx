...
const Footer: FC<footerProps> = () => {
    ...
    return (<footer className="bg-black mt-16 ">
...
{/* <div className="py-10 mt-52 bg-gradient-to-r from-sky-950 rounded-tr-[250px] rounded-t-[250px] rounded-tl-[250px]   via-sky-700 via-30% to-sky-600 to-70%">
 <div className="flex justify-center items-center">
    <div className="max-w-7xl flex flex-col justify-center gap-3 items-center">
  <div className="mb-6 md:mb-0 flex flex-col gap-3">
              <a href="/" className="flex items-center">
                  <Image src={logo} className="h-12 w-12  " alt="BowdicSoft Logo" />
                  <span className="self-center text-3xl font-bold  text-white pl-2">BawdicSoft</span>
              </a>
                  <p className="text-md font-semibold text-gray-200 ">Sofware Services and Development</p>
...
<Link href={"/"} className="text-white hover:text-gray-500 px-5 font-medium text-sm">Contact Us</Link>
 ...
 < p className="text-sm md:text-base text-gray-200">© 2018 BawdicSoft. All rights reserved.</p>
    </div>
  </div> 
    </div> */}
