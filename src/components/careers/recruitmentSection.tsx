...
const RecruitmentSection: FC<recruitmentSectionProps> = () => {
 ...
 <section className="flex justify-center items-center flex-col py-10 md:py-20  " >
    ...
    Our Recruitment Process
       ...
       <p className="text-gray-800 text-center text-sm md:text-lg max-w-5xl pb-4 md:pb-0 ">From application to onboarding, we streamline every step while allowing you to focus on showcasing your talents and potential – effortlessly.</p>
      </div>
...
<svg className="fill-current" height="50px" width="50px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  
	 viewBox="0 0 204.376 204.376">
         <defs>
    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" style={{ stopColor: "#082f49", stopOpacity: 1 }} />
      <stop offset="30%" style={{ stopColor: "#0369a1", stopOpacity: 1 }} />
      <stop offset="70%" style={{ stopColor: "#0284c7", stopOpacity: 1 }} />
    </linearGradient>
  </defs>
<path fill="url(#gradient)"  d="M171.247,204.376c2.484,0,4.5-2.015,4.5-4.5V61.35h-51.744c-7.502,0-13.605-6.107-13.605-13.614V0H33.13
	...
	S54.134,92.627,57.999,92.627z M57.999,117.627c3.865,0,7,3.134,7,7s-3.135,7-7,7s-7-3.134-7-7S54.134,117.627,57.999,117.627z
	 ...
	 M120.397,47.736V10.396l43.802,40.953h-40.196C122.014,51.35,120.397,49.729,120.397,47.736z"/>
       ...
       <h1 className="text-lg md:text-2xl lg:text-3xl  font-bold">Application</h1>
       <p className="text-sm  md:text-base text-gray-700">Submit your application to Geeks of Kolachi and get the ball rolling.</p>
     </div>
     <div className="text-center border bg-white p-8 md:p-14 rounded-3xl flex flex-col justify-start items-center gap-4">
<svg  className="fill-current" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
	 width="50px" height="50px" viewBox="0 0 943.118 943.118"
	>
          <defs>
    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" style={{ stopColor: "#082f49", stopOpacity: 1 }} />
...
<g>
	<g>
		<g>
			<path  fill="url(#gradient)" d="M54.182,670.915v189.128c0,11.047,8.955,20,20,20h362.347c-3.137-6.688-4.899-14.143-4.899-22.006V670.915H54.182z"/>
			<path  fill="url(#gradient)" d="M30,639.904h24.182h377.446V622.67v-24.418c0-0.229,0.007-0.456,0.009-0.685c0.107-15.218,3.8-29.6,10.277-42.337
			...
			<path fill="url(#gradient)"  d="M329.919,368.094c73.717,0,133.477-59.76,133.477-133.477V92.744c0-18.391-16.561-32.347-34.686-29.233
			...
			<path  fill="url(#gradient)" d="M526.859,533.021c-10.345,0-20.121,2.418-28.812,6.703c-7.723,3.809-14.576,9.102-20.201,15.506
			...
			<path  fill="url(#gradient)" d="M702.375,497.769c80.854,0,146.4-65.546,146.4-146.4v-84.396c0-31.052-21.886-57.8-52.322-63.941
       ...
       <h1 className="text-lg md:text-2xl lg:text-3xl font-bold">Interview</h1>
       <p className="text-sm  md:text-base text-gray-700">Join us for an interview to unfold and unlock mutual potential together.</p>
     </div>
     <div className="text-center border bg-white p-8 md:p-14 rounded-3xl flex flex-col justify-start items-center gap-4">
<svg
...
>
  ...
  />
       ...
       <h1 className="text-lg md:text-2xl lg:text-3xl font-bold">Onboarding</h1>
       <p className="text-sm  md:text-base text-gray-700">You 're officially a geek now! Welcome to an exciting chapter of growth and collaboration.</p>
     </div>
   </div>
 </section>
