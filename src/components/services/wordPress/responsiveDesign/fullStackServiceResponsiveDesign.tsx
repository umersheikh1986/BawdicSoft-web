...
const FullStackSectionResponsiveDesign: FC<fullStackSectionProps> = () => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  md:px-16  gap-10  py-8">
          <div className="px-5 md:px-0">
            <AnimatedComponentLeft>
              <Image
                src={
                  "/images/blockChain/NFT/nftMarketPlace/fullStackImage.webp"
                }
                alt=""
                width={330}
                height={270}
...
export default FullStackSectionResponsiveDesign;
