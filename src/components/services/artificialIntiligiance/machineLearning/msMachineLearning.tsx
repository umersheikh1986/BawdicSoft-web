...
interface MasterMachineSectionMachineLearningProps {}
...
const MasterMachineSectionMachineLearning: FC<
  MasterMachineSectionMachineLearningProps
> = () => {
...
export default MasterMachineSectionMachineLearning;
