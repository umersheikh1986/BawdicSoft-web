...
interface MasterMachineSectionNaturalLanguageProps {}
...
const MasterMachineSectionNaturalLanguage: FC<
  MasterMachineSectionNaturalLanguageProps
> = () => {
...
export default MasterMachineSectionNaturalLanguage;
