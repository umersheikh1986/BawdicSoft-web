...
import heroImage from "../../../../../public/images/blockChain/TokenExcahge/heroSection.jpg";
    ...
    >
      <div className="px-4 mx-auto max-w-7xl text-center  md:pt-56 lg:py-56">
        ...
        <p className="mb-8  md:text-lg font-normal text-gray-300 lg:text-xl sm:px-16 ">
          Crypto Token Development Utilize our expertise in developing trusted,
          secured and customized crypto tokens and instantly deploy any service
          of your choice on the Blockchain.
        </p>
      </div>
    </section>
  );
