        ...
        <div className="flex justify-center bg-sky-950">
            <div className="pt-10  md:px-16 md:pt-16 pb-20 md:pb-20  max-w-7xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  pt-10 md:px-16 gap-10">
                    ...
                    <div className=" border-2 hover:border-sky-500  p-6  border border-gray-200 rounded-lg shadow  ">
                        <span >
                            <h5 className="mb-2 text-lg md:text-2xl font-bold tracking-tight text-gray-900 text-white  ">Burnability</h5>
                        </span>
                    ...
                    <div className=" border-2 hover:border-sky-500  p-6  border border-gray-200 rounded-lg shadow  ">
                        <span >
                            <h5 className="mb-2 text-lg md:text-2xl font-bold tracking-tight text-gray-900 text-white  ">Minting</h5>
                        </span>
                    ...
                    <div className=" border-2 hover:border-sky-500   p-6  border border-gray-200 rounded-lg shadow  ">
                        <span >
                            <h5 className="mb-2 text-lg md:text-2xl font-bold tracking-tight text-gray-900 text-white  ">Pausability
</h5>
                        </span>
                    ...
                    <div className=" border-2 hover:border-sky-500   p-6  border border-gray-200 rounded-lg shadow  ">
                        <span >
                            <h5 className="mb-2 text-lg md:text-2xl font-bold tracking-tight text-gray-900 text-white  ">Supply limitation
</h5>
                        </span>
                    ...
                    <div className=" border-2 hover:border-sky-500   p-6  border border-gray-200 rounded-lg shadow  ">
                        <span >
                            <h5 className="mb-2 text-lg md:text-2xl font-bold tracking-tight text-gray-900 text-white  ">Authority
</h5>
                        </span>
