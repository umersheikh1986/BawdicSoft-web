    ...
    return (
        <div className='flex items-center justify-center '>
         ...
         <div className=" md:mx-5    px-5  flex  flex-col justify-center items-center md:justify-start md:items-start pt-20 pb-5">
                <p className="text-white font-bold text-2xl  md:text-3xl lg:text-4xl text-center md:text-start">Got an idea, talk to our experts and get a quote on your project.</p>
            ...
            <Image src={centralizedCrypto} alt='' width={300 } height={300} className='md:w-72 md:h-72 pt-8  w-84 h-80'/>
            </div>
         </div>
        </div>
