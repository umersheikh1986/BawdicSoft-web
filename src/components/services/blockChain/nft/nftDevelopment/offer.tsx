        ...
        <div>
            <div className="pt-10 md:pt-16 pb-20 md:pb-32">
                ...
                <div className="flex gap-10 justify-center flex-wrap items-center">
                    ...
                    <div className="max-h-44 border-2 hover:border-sky-800 max-w-md md:max-w-sm  p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                    ...
                    <div className="max-h-44 max-h-44 border-2 hover:border-sky-800 max-w-md max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                    ...
                    <div className="max-h-44 border-2 hover:border-sky-800 max-w-md max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
