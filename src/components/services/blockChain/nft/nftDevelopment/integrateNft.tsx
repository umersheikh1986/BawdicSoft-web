...
const IntegratSection: FC<IntegratSectionProps> = () => {
    ...
    return (
       ...
       <div className=' max-w-7xl grid grid-cols-1 md:grid-cols-2  md:px-16  gap-5  mt-8 py-16 md:mt-16'>
        <div>
            <Image src={imageData.image.src} alt='' width={330} height={300} className='w-80 h-80 md:w-96 md:h-96 '/>
        </div>
        <div className=' pt-10 px-5  md:pt-5'>
    <p className='mb-4 text-2xl font-semibold tracking-tight leading-7 text-white md:text-4xl lg:text-5xl '>Integrating NFTs into Business</p>
