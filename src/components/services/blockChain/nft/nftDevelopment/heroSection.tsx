...
const HeroSection: FC<HeroSectionProps> = () => {
    ...
    return (
        <section className=" pt-32 md:pt-0 bg-center bg-cover bg-no-repeat  bg-gray-500 bg-blend-multiply" style={{
            ...
            <div className="px-4 mx-auto max-w-7xl text-center py-24 md:pt-56 lg:py-56">
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-6xl lg:text-7xl -ml-30">
                    NFT Development​</h1>
                <p className="mb-8  md:text-lg font-normal text-gray-300 lg:text-xl sm:px-16 ">We are an NFT development company transforming your creative ideas into modern digital assets using error-free ERC721 and ERC1155 standards. Your digital assets represent your creativity in the NFT marketplace and make you a part of today's digital world.
                </p>
