    ...
    return (
        <section className=" pt-32 md:pt-30 lg:pt-0 bg-center bg-cover bg-no-repeat  bg-gray-500 bg-blend-multiply" style={{
            ...
            <div className="px-4 mx-auto flex flex-col items-center justify-center text-center py-24 lg:pt-44">
                ...
                <p className="mb-8  md:text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Trust us with creating the most captivating NFT marketplace for you. You can sell and trade your own digital assets or offer services to other NFT enthusiasts.
                </p>
