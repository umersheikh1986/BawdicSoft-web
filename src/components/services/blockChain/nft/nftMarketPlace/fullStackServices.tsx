...
<p className=' md:text-3xl lg:text-4xl text-2xl  max-w-6xl font-bold text-center pt-5 pb-5 px-16'>We provide full-stack development services for NFT marketplace</p>
       ...
       <div className='grid grid-cols-1 md:grid-cols-2  md:px-16 lg:px-32 gap-10  py-8'>
        <div className='px-5 md:px-0'>
            <Image src={imageData.image.src} alt='' width={330} height={270} className='w-full  h-84 '/>
        </div>
        <div className=' px-5  '>
