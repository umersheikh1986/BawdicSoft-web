    ...
    return ( <div className="flex justify-center bg-sky-950">
        <div className="pt-10 md:pt-16 pb-20 md:pb-32  max-w-7xl">
            <div className='flex justify-center'>
                <p className=' md:text-4xl lg:text-4xl  text-3xl  text-white max-w-5xl font-bold text-center pt-5 pb-7 px-16'>Our tokens are</p>
            </div>
            <div className=" grid grid-cols-1 md:grid-cols-2 gap-4 mx-8 md:mx-16 ">
                ...
                <div className="pb-4  border-2 border-gray-200 hover:border-blue-400  p-3   rounded-lg  ">
                    <span >
                        <h5 className="mb-2 text-2xl md:text-3xl font-bold tracking-tight text-gray-900 text-white">Customized</h5>
                    </span>
                ...
                <div className=" pb-4 border-2 border-gray-200 hover:border-blue-400   p-3   rounded-lg  ">
                    <span >
                        <h5 className="mb-2 text-2xl md:text-3xl font-bold tracking-tight text-gray-900 text-white">Automated</h5>
                    </span>
                ...
                <div className=" pb-4 border-2 border-gray-200 hover:border-blue-400   p-3   rounded-lg  ">
                    <span >
                        <h5 className="mb-2 text-2xl md:text-3xl font-bold tracking-tight text-gray-900 text-white">Easy to use</h5>
                    </span> 
                ...
                <div className=" pb-4 border-2 border-gray-200 hover:border-blue-400   p-3   rounded-lg  ">
                    <span >
                        <h5 className="mb-2 text-2xl md:text-3xl font-bold tracking-tight text-gray-900 text-white">Reliable</h5>
                    </span>
