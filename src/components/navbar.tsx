      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          {checkClick && (
            ...
            className="absolute z-10 grid  gap-8 lg:w-[950px] xl:w-[1200px] grid-cols-2 text-sm bg-white border border-gray-100 rounded-lg shadow-md  md:grid-cols-3 lg:grid-cols-4  mt-10 pb-4 left-1/2 transform -translate-x-1/2 max-w-7xl "
            >
            <div className="absolute h-4 w-4 bg-white border-t border-l  border-gray-200 transform rotate-45 top-0 left-1/2 -mt-2  xl:ml-28"></div>
              ...
              {/* WordPress Section */}
              <div className="pt-4 relative pl-4 text-gray-900 md:pb-4 ">
                <div
                  className="space-y-4"
                  aria-labelledby="mega-menu-dropdown-button"
                >
