    ...
    <header className="bg-white sticky top-0 z-40">
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Link
            href="/"
            className="text-sm font-bold leading-6 text-sky-60 text-white hover:text-black text-[17px] focus:text-black focus:border-none"
          >
            Home
          </Link>
          {/* <DropDown /> */}
          ...
          <Link
            href="/portfolio"
            className="text-sm font-bold leading-6 text-white hover:text-black text-[17px] focus:text-black focus:border-none"
          >
            Portfolio
          </Link>
          <Link
          ...
          <Link
            href="/careers"
            className="text-sm font-bold leading-6 p-1 text-sky-600 hover:text-black text-[17px] focus:text-black focus:border-none"
          >
            Sign in
          </Link>
          <Link
            href="/contact-us"
            className="text-sm font-bold leading-6 border-2 p-1 border-sky-600  text-sky-600 hover:text-black text-[17px] focus:text-black focus:border-none"
          >
            Join
          </Link>
        </Popover.Group>
